...
/* 
  ...
  1. Window Binding - when none of the other rules apply, this will return the window or
  the global object in node or undefined in strict mode.
  2. Implicit binding - when the function is invoked look to the left of the dot thats what
  this refers to
  3. Explicit binding - .call, .apply, .bind
  4. new binding - when a function is created as a constructor this points
  to the newly create object
*/

///////// END OF CHALLENGE /////////

/* 🛑🛑🛑🛑🛑🛑🛑🛑🛑🛑 Pleasethis do not modify anything below this line 🛑🛑🛑🛑🛑🛑🛑🛑🛑🛑 */
function foo(){
